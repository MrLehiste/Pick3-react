...
import { classNames, DATE_OPT_MDY4 } from './UI/constants';
...
export default function DrawsHistory({ state, dtFrom, dtTo }) {
  ...
  if (data) {
    ...
    <thead className="bg-gray-50">
      <tr>
        <th scope="col" className="rounded-tl-lg py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-6">
